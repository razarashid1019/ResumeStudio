...
// This is a Vite app, not Next.js -- swap in a plain anchor with the same
// href/className/children signature next/link's Link exposes so the rest
// of this file (copied as-is from Skiper UI) needs no other changes.
const Link = ({
  href,
  className,
  children,
